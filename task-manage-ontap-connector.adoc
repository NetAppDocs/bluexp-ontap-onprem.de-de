...
+
--
https://docs.netapp.com/us-en/cloud-manager-replication/task-replicating-data.html["Replizierungsdokumentation"^]

--
Daten sichern:: Mithilfe von Cloud Backup können Sie Daten von einem lokalen ONTAP System auf kostengünstigen Objekt-Storage in der Cloud sichern.
+
--
https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html["Dokumentation für Cloud-Backup"^]
...
+
--
https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html["Cloud Data Sense Dokumentation"^]

--
Tiering von Daten in die Cloud:: Erweitern Sie Ihr Datacenter in die Cloud, indem Sie inaktive Daten automatisch von ONTAP Clustern auf Objekt-Storage mithilfe von Cloud-Tiering verschieben.
+
--
https://docs.netapp.com/us-en/cloud-manager-tiering/concept-cloud-tiering.html["Dokumentation für das Cloud-Tiering"^]
